...
(function () {
    ...
    window.UEDITOR_CONFIG = {
        ...
        //与工程名保持一致
        ,contextRootPath:'/ancientVillage'
        // 服务器统一请求接口路径
    	...
    	//文件下载后台
       	...
       	,fileFieldName:'file'
       	//涂鸦后台类及方法
       	,scrawlActionName:'/upload/scrawlUpload'
       	,scrawlFieldName:'upfile'
       		
       	//视屏上传后台类以及方法
       	,videoActionName:'/upload/images'
       	,videoFieldName: 'file' /* 提交的视频表单名称 */
       	,videoUrlPrefix:'/ancientVillage/upload/fileDownLoad?url='/* 视频访问路径前缀 */
