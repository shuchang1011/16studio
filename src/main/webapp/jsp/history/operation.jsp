		...
		<div class="widget_contents noPadding">
			<table class="datatable tables" id="DataTables_Table_0">
				...
				<tr>
					...
					<th style="width: 20%;">目标ID</th>
					<th style="width: 10%;">操作</th>
					<th style="width: 20%;">创建时间</th>
					<th style="width: 10%;"colspan="2">operation</th>
				</tr>
				<%
					int i = 1;
				%>
				<c:forEach items="${pageInfo.list}" var="list">
					<tr>
			            ...
			            <td style="width: 20%;">${list.target }</td>
			            <td style="width: 20%;">${list.targetId }</td>
			            <td style="width: 10%;">${list.operation }</td>
			            <td style="width: 20%;">${list.createDate }</td>
			            <td style="width: 10%;"><form action="${pageContext.request.contextPath}/history/getOperationDetail" method="get">
