			...
			<table class="datatable tables" id="DataTables_Table_0">
				...
				<c:forEach items="${pageInfo.list}" var="list">
					<tr>
			            ...
			            <td style="width: 10%;"><form action="${pageContext.request.contextPath}/history/recoveryHistory" method="post">
			            	<input type="hidden" name="villageId" value="${list.getId() }">
		            	  	<input type="submit" value="还原" class="submitIt simple_buttons"/>
		            	</form></td>
			        </tr>
				</c:forEach>
				</thead>
		...
		<table>
			...
			<c:forEach items="${pageInfo.list}" var="list">
				<tr>
		            ...
		            <td><form action="${pageContext.request.contextPath}/history/recoveryHistory" method="post">
		            	<input type="hidden" name="villageId" value="${list.getId() }">
