...
<body>
	...
	<div class="g_12 editor_info" id="editor_info">
		...
		<div class="widget_contents noPadding">
			<form id="form1" action="${pageContext.request.contextPath}/account/update" method="post" onsubmit="submitForm()">
...
<script>
	function submitForm() {
		$.ajax({            //几个参数需要注意一下
			...
			url: "${pageContext.request.contextPath}/account/update" ,//url
