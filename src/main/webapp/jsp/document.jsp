				...
				<c:forEach items="${pageInfo.list}" var="list">
					<tr>
			            ...
			            <td style="width: 20%;">${list.createDate }</td>
		          	 	<td style="width: 10%;text-align: center"><form action="${pageContext.request.contextPath}/document/getOne/${list.getId()}" method="get">
			            	  	<input type="submit" value="查看详情" class="submitIt simple_buttons"/>
			            </form></td>
			            <td style="width: 10%;text-align: center"><form action="${pageContext.request.contextPath}/document/${list.getId() }/delete" method="post">
